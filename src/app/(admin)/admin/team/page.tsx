...
import { Upload, Users, Plus, Save, X, Edit2, Trash2 } from 'lucide-react';
...
export default function TeamPage() {
  ...
  const handleDelete = async (id: string) => { if (!confirm('Delete this team member?')) return; await fetch(`/api/admin/team/${id}`, { method: 'DELETE' }); fetchData(); };
      ...
      <div className="p-4 md:p-8">
        ...
        {showForm && (
          <div style={{ background: 'var(--admin-bg-card)', boxShadow: 'var(--admin-shadow)', border: 'none', borderRadius: '12px', padding: '24px', marginBottom: '24px' }}>
            <h3 style={{ color: 'var(--admin-text-primary)', fontSize: '1rem', fontWeight: 600, fontFamily: 'var(--font-outfit), sans-serif', margin: '0 0 20px' }}>{editingId ? 'Edit' : 'Add'} Team Member</h3>
